    ...
    return (
      ...
      <div className="col-12 col-md-5 col-lg-8 d-flex align-items-center justify-content-md-end mt-3 mt-md-0">
        ...
        <div className="dropdown">
          <button className=" btn dropbtn dropdown-toggle " type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false">
            <span className="account-user-name"> Foulen ben foulen </span>
            <img className ="img-profile" src="../assets/images/users/avatar-10.jpg" alt="Profile photo"/>
          </button>
          ...
          <ul className="dropdown-menu " aria-labelledby="dropdownMenuButton">
            ...
            <li>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M4 18h2v2h12V4H6v2H4V3a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3zm2-7h7v2H6v3l-5-4l5-4v3z"/></svg>
              Log out
            </a>
            </li>
          </ul>
